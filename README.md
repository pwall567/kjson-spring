...
The latest version of the library is 3.3 (the version number of this library matches the version of `kjson` with which
...
### Gradle
```groovy
    implementation 'io.kjson:kjson-spring:3.3'
```
### Gradle (kts)
```kotlin
    implementation("io.kjson:kjson-spring:3.3")
