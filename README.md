...
The latest version of the library is 4.1 (the version number of this library matches the version of `kjson` with which
...
### Gradle
```groovy
    implementation 'io.kjson:kjson-spring:4.1'
```
### Gradle (kts)
```kotlin
    implementation("io.kjson:kjson-spring:4.1")
